...
const artifactList: Map<string, Artifact<StoryResource>> = new Map();
...
export function addArtifacts(artifacts: ArtifactDefinition<StoryResource>[], reset: boolean) {
    if (reset) {
        artifactList.clear();
    }
...
export function getArtifact(id: string): Artifact<StoryResource> | undefined {
